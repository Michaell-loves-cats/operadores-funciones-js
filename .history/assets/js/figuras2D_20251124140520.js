...
// Asignar números al azar a cada variable
...
document.getElementById("TriAP").innerHTML = `Perímetro: ${perimetroTriangulo} (a=${a}, b=${b}, c=${c})`;
document.getElementById("TriAA").innerHTML = `Área: ${areaTriangulo.toFixed(2)} (b=${b}, h=${h})`;