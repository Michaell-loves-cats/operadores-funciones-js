...
// Círculo
let Perimetrocir = 2 * PI * r;
let Areacir = PI * r^2;
document.getElementById("cirP").innerHTML = "2 * PI * " + r + " = " + Perimetrocir;
document.getElementById("cirA").innerHTML = "PI * " + r + "^2 = " + Areacir;
