...
// Cometa
let Perimetrocometa = 4 * a 2 * (a + b);
let Areacometa = (D * d) / 2;
document.getElementById("cometaP").innerHTML = "Perímetro: 4 * " + a + " = " + Perimetrocometa;
document.getElementById("cometaA").innerHTML = "Área: (" + D + " * " + d + ") / 2 = " + Areacometa;
