...
document.getElementById("paraleloP").innerHTML = "Perímetro: 2 * (" + a + " + " + b +") = " + Perimetro;
document.getElementById("paraleloA").innerHTML = "Área: (" + b + " * " + h + ") = " + AreaTria;

// Rectangulo
let PerimetroRectA = 2 * (a + b);
let AreaRectA = b * a;
document.getElementById("RectAP").innerHTML = "Perímetro: 2 * (" + a + " + " + b +") = " + PerimetroTriA;
document.getElementById("RectAA").innerHTML = "Área: (" + b + " * " + a + ") = " + AreaTria;

// Cuadrado
let Perimetrocua = 4 * a;
let Areacua = a ** 2;
document.getElementById("cuaP").innerHTML = "Perímetro: 4 * " + a + " = " + PerimetroTriA;
document.getElementById("cuaA").innerHTML = "Área: " + a + "^2 = " + AreaTria;